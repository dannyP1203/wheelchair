...
////////////////////////////////////////////////////////////////////////////////
// Constructor
microstrain_3dmgx2_imu::IMU::IMU() : fd(-1), continuous(true), is_gx3(true)
{ }
...
microstrain_3dmgx2_imu::IMU::openPort(const char *port_name)
{
  ...
  if (fd < 0)
  {
    ...
    IMU_EXCEPT(microstrain_3dmgx2_imu::Exception, "Magnetometer OFF.Unable to open serial port [%s]. %s. %s", port_name, strerror(errno), extra_msg);
  }
...
//Deactivate  MAg
bool
microstrain_3dmgx2_imu::IMU::setMagOff()
{
...
//Activate  MAg
bool
microstrain_3dmgx2_imu::IMU::setMagOn()
{
